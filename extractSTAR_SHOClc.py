...
#          print >> RAWlightcurve, datalist[0][i], datalist[1][i], datalist[2][i], hjdvalue, datalist[4][i], datalist[5][i], "#"     
   ...
   for k in range(len(diffphot)):
       print >> differential, diffphot[k][3], diffphot[k][4], diffphot[k][5], diffphot[k][0], diffphot[k][1]*overallaverage, diffphot[k][2], diffphot[k][6], diffphot[k][7], diffphot[k][8]
